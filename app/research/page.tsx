  ...
  const fallbackPapers = [
    {
      ...
      authors: "Dr. Naina Kapoor",
      college: "ARK Research Lab",
      abstract: "This study introduces a quantitative metric to measure founder execution capacity by analyzing code push frequencies, product ship speeds, and customer validation loop rhythms. By comparing operational cadences of over 200 seed-stage ventures, we demonstrate that consistent operational discipline maps higher to eventual Series A milestones than general pitch deck narrative scores.",
      pdf_url: "https://picsum.photos/seed/pdfres1/800/1200",
      peerReviewed: true,
      conference: "NeurIPS",
    ...
    },
    {
      ...
      college: "IIT Bombay",
      abstract: "We investigate the emergence of secondary and tertiary innovation nodes in India, specifically looking at hubs surrounding KLH Hyderabad, BITS Goa, and IIT Kanpur. Utilizing geospatial spatial statistics and localized job listing densities, we show how decentralized incubator funding structures are scaling local engineering talent retention.",
      pdf_url: "https://picsum.photos/seed/pdfres2/800/1200",
      peerReviewed: true,
      conference: "Springer",
      doi: "10.1007/s00168-025-01210-y"
    }
  ];

  const displayPapers = papers.length > 0 ? papers : fallbackPapers;
        ...
        {loading ? (
          ...
          <div className="mt-10 space-y-4">
            ...
            {filteredPapers.length === 0 && (
              <div className="rounded-3xl border border-dashed border-black/10 p-12 text-center bg-white">
                <span className="text-4xl">🔬</span>
                <h3 className="mt-4 font-display text-xl font-bold text-ark-black">No papers found</h3>
                <p className="mt-1 text-sm text-zinc-500">Check back shortly for updated academic studies.</p>
              </div>
            )}
          </div>
        )}
