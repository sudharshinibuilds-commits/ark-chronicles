  ...
  const fallbackChronicles = [
    {
      ...
      image_url: "https://picsum.photos/seed/ind-ai/600/400"
    },
    {
      id: "chronicle-2",
      ...
      image_url: "https://picsum.photos/seed/organ/600/400"
    },
    {
      id: "chronicle-3",
      ...
      tags: ["Capital", "SaaS"],
      image_url: "https://picsum.photos/seed/fin/600/400"
    }
  ];

  const displayArticles = articles.length > 0 ? articles : fallbackChronicles;
