  ...
  const fallbackOpportunities = [
    {
      ...
      daysLeft: 14,
      desc: "Work closely with senior product designers shaping food tech delivery logistics for 20M+ users.",
    },
    {
      id: "opp-2",
      type: "Grant",
      typeColor: "bg-emerald-600",
      title: "Deep-Tech Startup India Grant",
      organization: "Startup India",
      location: "Pan India",
      stipend: "Up to ₹50 Lakhs",
      deadline: "August 15, 2026",
      daysLeft: 35,
      desc: "Government grant aimed at providing proof-of-concept capital for university research spinoffs.",
    },
    {
      id: "opp-3",
      type: "Fellowship",
      typeColor: "bg-indigo-600",
      title: "A.R.K. Innovation Fellowship",
      organization: "ARK Council",
      location: "Remote / Hybrid",
      stipend: "₹1,00,000 stipend",
      deadline: "July 18, 2026",
      daysLeft: 7,
      desc: "Our flagship fellowship providing mentorship, stipends, and partner ecosystem support to student operators.",
    },
    {
      id: "opp-4",
      type: "Hackathon",
      typeColor: "bg-amber-600",
      title: "HackIndia Agents Build 2026",
      organization: "ARK Communities",
      location: "Bengaluru Physical",
      stipend: "₹10 Lakh Pool",
      deadline: "July 20, 2026",
      daysLeft: 9,
      desc: "Build collaborative multi-agent code workflows over a 48-hour sprint. Accommodation provided.",
    },
    {
      id: "opp-5",
      type: "Incubator",
      typeColor: "bg-rose-600",
      title: "T-Hub Student Cohort Alpha",
      organization: "T-Hub",
      location: "Hyderabad",
      stipend: "Incubation space",
      deadline: "August 30, 2026",
      daysLeft: 50,
      desc: "Join a 3-month capital strategy and market sprint. Office access, AWS credits, and mentor pairing.",
    }
  ];

  const displayOpportunities = opps.length > 0 ? [...opps, ...fallbackOpportunities] : fallbackOpportunities;
