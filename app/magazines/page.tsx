...
export default function MagazinesPage() {
  ...
  const fallbackMagazines = [
    {
      ...
      issue_no: "Edition 12",
      description: "Shaping the Next Wave of Indian Tech Abundance: Inside details of decisions made by seasoned operators.",
      category: "Special Edition",
      cover_url: "https://picsum.photos/seed/magcover1/400/600",
      pdf_url: "https://picsum.photos/seed/pdf1/800/1200",
      edition: "Edition 12",
      month: "July",
      year: "2026",
      author: "ARK Desk"
    ...
    {
      id: "mag-2",
      title: "Deep Tech Frontiers: Climate and Biomaterials",
      issue_no: "Edition 11",
      description: "How IIT Bombay researchers are using agricultural waste to synthesize bio-degradable shipping wraps.",
      category: "Research",
      cover_url: "https://picsum.photos/seed/magcover2/400/600",
      pdf_url: "https://picsum.photos/seed/pdf2/800/1200",
      edition: "Edition 11",
      month: "June",
      year: "2026",
      author: "ARK Desk"
  ...
  const displayMagazines = magazinesList.length > 0 ? magazinesList : fallbackMagazines;
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            {filteredMagazines.length === 0 && (
              <div className="col-span-full rounded-2xl border border-dashed border-black/10 p-12 text-center bg-white">
                ...
                <p className="mt-1 text-sm text-zinc-500">Check back shortly for updated publications.</p>
              </div>
            )}
          </div>
        )}
