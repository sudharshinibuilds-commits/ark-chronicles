          ...
          <div className="lg:col-span-1">
            <div className="overflow-hidden rounded-2xl border border-black/8 bg-white p-6 shadow-lg">
              ...
              <div className="mt-6 flex flex-col gap-3">
                <a
                  href="#"
                  className="flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold text-white transition-all duration-150 hover:scale-105"
                ...
                <a
                  href="mailto:aarav@pulseforge.ai"
                  className="flex items-center justify-center gap-2 rounded-full border border-black/10 bg-zinc-100 px-4 py-2.5 text-sm font-semibold text-ark-black transition-all duration-150 hover:scale-105 hover:border-ark-navy hover:bg-ark-navy/5"
                >
                ...
                <p className="text-center text-sm text-zinc-600">aarav@pulseforge.ai</p>
              </div>
